...
// this may have very little affect based on the values that are generated by
// the data generation portion of the algorithm

// sadly can't push up to 512 with this or the compiler runs out of steps
constexpr int maxiters = MAXITERS;
#if 0
#ifdef MAXITERS_16
  constexpr int maxiters = 16;
#elif MAXITERS_32
  constexpr int maxiters = 32;
#elif MAXITERS_64
